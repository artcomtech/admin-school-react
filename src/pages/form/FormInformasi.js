                    ...
                    <div className="row">
                        ...
                        <div className='col-md-12'>
                            <div className="form-group">
                                ...
                                <button className='btn btn-xs btn-warning mt-4'><i className='fa fa-arrow-left'></i> Kembali</button>
                                <button className='btn btn-xs btn-primary mt-4 ml-2'><i className='fa fa-save'></i> Simpan</button>
                            </div>
                        </div>
                    </div>
                </div>
